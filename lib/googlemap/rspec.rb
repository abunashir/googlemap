...
# do so by adding `require "googlemap/rspec"` on top of `spec_helper`
#
require File.join(Googlemap.root, "spec/support/fake_googlemap_api.rb")

RSpec.configure do |config|
  config.include Googlemap::FakeGooglemapApi
end
